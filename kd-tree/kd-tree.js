 ...
 */
var KdNode = function (obj, d, parent) {
  this.obj = obj;
  this.left = null;
  this.right = null;
  this.parent = parent;
 ...
 */
var KdTree = function (points, metric, dimensions, tolerance) {
  var self = this;
  ...
  this.insert = function (point) {
    ...
    if (insertPosition === null) {
      self.root = new KdNode(point, 0, null);
      return;
    }
  ...
  this.insertUnique = function (p) {
    ...
    node = new KdNode(p, isOddLevel ? 1 : 0, parentNode);
    nodeName = p.x + ', ' + p.y;
