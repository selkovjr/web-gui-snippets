...
// Modified by Eugene Skepner to satisfy jslint
...
function printStackTrace(options) {
  ...
  var ex = options.e || null, guess = !!options.guess,
      p = new printStackTrace.implementation(), result = p.run(ex);
  return (guess) ? p.guessAnonymousFunctions(result) : result;
}

Y.ACMACS.printStackTrace = printStackTrace;
